...
@section('title', 'Thêm danh mục | Tinh Hoa Tây Bắc')
            ...
            <div class="category-form-grid">
                <div class="category-card">
                    <form action="{{ route('admin.categories.store') }}" method="POST">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}"
                               ...
                               placeholder="Ví dụ: Thịt gác bếp" maxlength="255" required autofocus>
                        @error('name')
                ...
                <aside class="category-card category-preview">
                    ...
                    <p class="text-muted mb-0">
                        Sau khi tạo, danh mục sẽ xuất hiện trong khu quản trị và dùng để phân loại sản phẩm.
                    </p>
                </aside>
            </div>
        </div>
